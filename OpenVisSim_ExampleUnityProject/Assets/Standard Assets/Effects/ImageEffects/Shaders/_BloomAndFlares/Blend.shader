...
Shader "Hidden/Blend" {
	...
	v2f_mt vertMultiTap( appdata_img v ) {
		v2f_mt o;
		o.pos = UnityObjectToClipPos(v.vertex);
		float2 tc = TRANSFORM_TEX(v.texcoord, _MainTex);
		o.uv[0] = tc + _MainTex_TexelSize.xy * 0.5;
		o.uv[1] = tc - _MainTex_TexelSize.xy * 0.5;	
		o.uv[2] = tc - _MainTex_TexelSize.xy * half2(1,-1) * 0.5;	
		o.uv[3] = tc + _MainTex_TexelSize.xy * half2(1,-1) * 0.5;	
		return o;
	}
