...
Shader "Hidden/MultipassHollywoodFlares" {
	...
	v2f_opts vertStretch (appdata_img v) {
		...
		o.uv[1] = o.uv[0] + b * 2.0 * offsets.xy;
		o.uv[2] = o.uv[0] - b * 2.0 * offsets.xy;
		o.uv[3] = o.uv[0] + b * 4.0 * offsets.xy;
		o.uv[4] = o.uv[0] - b * 4.0 * offsets.xy;
		o.uv[5] = o.uv[0] + b * 6.0 * offsets.xy;
		o.uv[6] = o.uv[0] - b * 6.0 * offsets.xy;
		return o;
	}
	...
	v2f_opts vertVerticalCoords (appdata_img v) {
		...
		o.pos = UnityObjectToClipPos(v.vertex);
		o.uv[0] = TRANSFORM_TEX(v.texcoord, _MainTex);
		o.uv[1] = o.uv[0] + 0.5 * _MainTex_TexelSize.xy * half2(0,1);
		o.uv[2] = o.uv[0] - 0.5 * _MainTex_TexelSize.xy * half2(0,1);
		o.uv[3] = o.uv[0] + 1.5 * _MainTex_TexelSize.xy * half2(0,1);
		o.uv[4] = o.uv[0] - 1.5 * _MainTex_TexelSize.xy * half2(0,1);
		o.uv[5] = o.uv[0] + 2.5 * _MainTex_TexelSize.xy * half2(0,1);
		o.uv[6] = o.uv[0] - 2.5 * _MainTex_TexelSize.xy * half2(0,1);
		return o;
	}	
