...
Shader "Hidden/BlendForBloom" {
	...
	v2f vert( appdata_img v ) {
		...
		o.uv[1] =  TRANSFORM_TEX(v.texcoord, _MainTex);
	...
	v2f_mt vertMultiTap( appdata_img v ) {
		v2f_mt o;
		o.pos = UnityObjectToClipPos(v.vertex);
		o.uv[4] = TRANSFORM_TEX(v.texcoord, _MainTex);
		o.uv[0] = o.uv[4].xy + _MainTex_TexelSize.xy * 0.5;
		o.uv[1] = o.uv[4].xy - _MainTex_TexelSize.xy * 0.5;	
		o.uv[2] = o.uv[4].xy - _MainTex_TexelSize.xy * half2(1,-1) * 0.5;	
		o.uv[3] = o.uv[4].xy + _MainTex_TexelSize.xy * half2(1,-1) * 0.5;	
		return o;
	}
